...
<head>
	...
	<title>Buku Tamu - RPL SMK Negeri 9 Semarang</title>
		...
		<div class="row p-3">
			<div class="col-md-8">
				<div class="title mb-3">
					Buku Tamu RPL - SMK Negeri 9 Semarang
				</div>
				<div>
					<form method="POST" action="proses_bukutamu.php">
						<div class="form-group">
							<label for="nama">Nama</label>
							<input type="text" class="form-control" id="nama" placeholder="nama" autocomplete="on" required="required" name="nama">
						</div>
						<div class="form-group">
							<label for="email">Email</label>
							<input type="Email" class="form-control" id="email" placeholder="email" autocomplete="on" required="required" name="email">
						</div>
						<div class="form-group">
							<label for="isi">Keperluan</label>
